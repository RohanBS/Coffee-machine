...
public class CoffeeMachine {
    ...
    public CoffeeMachine(int totalAmountWater, int totalAmountMilk,
                         int totalAmountCoffeeBeans, int totalAmountDisposablesCup,
    ...
    private void buyAction() {
        ...
        if (!answer.equals("back")) {
            try {
                typeCoffee = Integer.valueOf(answer);
...
abstract class Coffee {
    ...
    public Coffee(int AMT_WATER_PER_PORTION, int AMT_MILK_PER_PORTION,
                  int AMT_COFFEE_BEANS_PER_PORTION, int priceCoffee) {
